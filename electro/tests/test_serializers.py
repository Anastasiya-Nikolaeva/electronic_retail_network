...
class SupplierSerializerTest(TestCase):
    ...
    def test_supplier_serializer_create(self):
        ...
        data = {
            ...
            "street": "Ростовская",
            "house_number": "2",
            "debt": 50.00,  # Это поле должно быть игнорируемым, так как оно read_only
        }
        ...
        )  # Проверка, что долг не установлен
    ...
    def test_supplier_serializer_email_unique(self):
        ...
        data = {
            ...
            "street": "Ростовская",
            "house_number": "3",
            "debt": 50.00,  # Это поле должно быть игнорируемым
        }
        serializer = SupplierSerializer(data=data)
        self.assertFalse(serializer.is_valid())
        self.assertIn("email", serializer.errors)
        self.assertEqual(serializer.errors["email"], ["Этот email уже используется."])
    ...
    def test_supplier_serializer_update(self):
        ...
        data = {
            ...
            "email": "new_email@example.com",  # Используем новый email
            "country": "Россия",
            "city": "Ростов на дону",
            "street": "Ростовская",
            "house_number": "4",
            "debt": 100.00,  # Это поле должно быть игнорируемым
        }
        ...
        self.assertEqual(
            updated_supplier.email, "new_email@example.com"
